...
// import Timeline, { TimelineProps } from "./progress";
// import { listGoogleDriveFiles } from "@/app/dashboard/_actions";
// import Link from "next/link";
// import { urlUpdation } from "@/lib/store";
...
// import { File } from "@/app/dashboard/_components/SearchItems";
...
// type DashboardProps = {
//   files: File["files"]; // Update the type accordingly
//   contacts: contact; // Update the type accordingly
// };
// export const Dashboard: React.FC<DashboardProps> = ({ files, contacts }) => {
    ...
    <div className="grid h-screen w-full pl-[53px]">
      ...
      <div className="flex flex-col">
        <header className="sticky top-0 z-10 flex h-[53px] items-center gap-1 border-b bg-background px-4">
          <h1 className="text-xl font-semibold">Filesphere.AI</h1>
          <Drawer>
...
//           {url && (
//             <div className="relative hidden flex-col items-start gap-8 md:flex">
//               <iframe title={"fileframe"} src={url} width="100%" height="100%" />
//             </div>
//           )}
//         </main>
//       </div>
